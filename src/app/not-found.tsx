...
export default function NotFound() {
  return (
    <div style={{
      ...
      <p style={{ fontSize: 10, color: '#CAFF00', letterSpacing: '0.12em', textTransform: 'uppercase', margin: '0 0 12px' }}>
        // 404
      </p>
      ...
      <Link href="/dashboard" style={{
        fontFamily: 'var(--font-mono)', fontSize: 12, color: '#CAFF00',
        border: '1px solid rgba(202,255,0,0.3)', borderRadius: 3,
