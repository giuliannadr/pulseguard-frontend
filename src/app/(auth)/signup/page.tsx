    ...
    return (
      <div className="min-h-dvh flex items-center justify-center p-6 relative overflow-hidden bg-[#05070A]">
        ...
        <motion.div 
          ...
          className="text-center fade-up max-w-sm relative z-10 glass-panel p-10"
        >
          <div className="w-20 h-20 bg-gradient-green rounded-full flex items-center justify-center mx-auto mb-6 shadow-[0_0_40px_rgba(142,254,161,0.5)]">
            <svg width="40" height="40" viewBox="0 0 24 24" fill="none"><polyline points="20 6 9 17 4 12" stroke="#000" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/></svg>
          </div>
          <h2 className="font-display font-bold text-2xl mb-3 text-white">Check your inbox</h2>
          ...
          <Link href="/login" className="btn-solid-glow inline-flex w-full justify-center">Back to login</Link>
        </motion.div>
      </div>
    );
  }
    ...
    <div className="min-h-dvh flex items-center justify-center p-6 relative overflow-hidden bg-[#05070A]">
      ...
      >
        ...
        <div className="mb-8 flex flex-col items-center">
          <div className="w-14 h-14 bg-gradient-green rounded-2xl flex items-center justify-center shadow-[0_0_40px_rgba(142,254,161,0.5)] mb-6">
          ...
          <p className="text-[var(--text-muted)] text-[15px]">Join Ethereal and monitor your services</p>
        </div>
        ...
        <p className="text-center mt-8 text-[15px] text-[var(--text-muted)]">
          ...
          <Link href="/login" className="text-white font-semibold hover:text-[var(--green-start)] transition-colors">Sign in</Link>
        </p>
      </motion.div>
...
function GithubIcon() {
  return <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.477 2 2 6.484 2 12.017c0 4.425 2.865 8.18 6.839 9.504.5.092.682-.217.682-.483 0-.237-.008-.868-.013-1.703-2.782.605-3.369-1.343-3.369-1.343-.454-1.158-1.11-1.466-1.11-1.466-.908-.62.069-.608.069-.608 1.003.07 1.531 1.032 1.531 1.032.892 1.53 2.341 1.088 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.113-4.555-4.951 0-1.093.39-1.988 1.029-2.688-.103-.253-.446-1.272.098-2.65 0 0 .84-.27 2.75 1.026A9.564 9.564 0 0 1 12 6.844a9.59 9.59 0 0 1 2.504.337c1.909-1.296 2.747-1.027 2.747-1.027.546 1.379.202 2.398.1 2.651.64.7 1.028 1.595 1.028 2.688 0 3.848-2.339 4.695-4.566 4.943.359.309.678.92.678 1.855 0 1.338-.012 2.419-.012 2.747 0 .268.18.58.688.482A10.019 10.019 0 0 0 22 12.017C22 6.484 17.522 2 12 2z"/></svg>;
}
