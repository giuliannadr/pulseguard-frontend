    ...
    <div className="min-h-dvh grid-bg flex items-center justify-center p-6">
      ...
      <div className="w-full max-w-[380px] fade-up">
        ...
        <div className="mb-10 text-center">
          ...
          <p style={{ color: 'var(--muted)', fontSize: 13 }}>Sign in to your monitoring dashboard</p>
        </div>
        ...
        <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 10, padding: '28px 28px' }}>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            {error && (
              <p style={{ fontSize: 12, color: 'var(--red)', background: 'rgba(255,59,107,0.08)', border: '1px solid rgba(255,59,107,0.15)', borderRadius: 6, padding: '8px 12px' }}>{error}</p>
            )}
        ...
        <p style={{ textAlign: 'center', marginTop: 20, fontSize: 13, color: 'var(--muted)' }}>
          No account yet?{' '}
          <Link href="/signup" style={{ color: 'var(--cyan)', textDecoration: 'none', fontWeight: 500 }}>Create one</Link>
        </p>
      </div>
