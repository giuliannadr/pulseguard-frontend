      ...
      <div style={{ background: '#080808', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 6, overflow: 'hidden' }}>
        ...
        <div style={{ padding: '0' }}>
          {loadingRepos ? (
             ...
             <div style={{ padding: '40px', textAlign: 'center', color: '#4A4A4A', fontFamily: 'var(--font-body)', fontSize: 14 }}>
               {githubToken ? "No public repositories found on your GitHub." : "You are not logged in with GitHub, or missing permissions."}
             </div>
          ) : (
